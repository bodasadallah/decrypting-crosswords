...
################# CHANGED HERE ##################################
    wandb_dir = wb_run_obj.settings.wandb_dir
    timespec = wb_run_obj.settings.timespec
    run_id = wb_run_obj.settings.run_id
    path_spec = f'{wandb_dir}/' + readable_name + f'-{timespec}-{run_id}'
##########################################################################

    sym_path = wb_run_obj.settings._path_convert(path_spec)
